...
function AddUser() {
    ...
    const users={                       // here this is used for collect data in write format
        fname:"",                           // hook is used for collect and update nad rerender data
        lname:"",
        email:"",
        password:""
    }
    const [user,setUser] = useState(users);   //import how to collect data from html page
    ...
    <div className="AddUser">
        ...
        <form className="addUserForm" onSubmit={submitForm}>
            ...
            <div className="inputGroup">
                ...
                <input type='email' onChange={inputHandler} id='email' name='email' autoComplete='off' placeholder='Email address'></input>
            </div>
            <div className="inputGroup">
